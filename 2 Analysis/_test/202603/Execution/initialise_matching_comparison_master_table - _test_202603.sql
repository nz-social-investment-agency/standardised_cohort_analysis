...
- [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_possible_client_matches_202603]
...
CREATE TABLE [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603] (
...
FROM [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_possible_client_matches_202603] AS m
...
IF (
	...
	AND
	(SELECT COUNT(*) FROM [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_client_202603]) >= 10
)
BEGIN -- startconditional population of table
	...
	INSERT INTO [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603] (snz_uid, reference_date, matching_date, age_ref_date)
	SELECT snz_uid
	...
	DELETE FROM [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603]
	WHERE snz_uid IN (SELECT snz_uid FROM [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_client_202603])
	
	-------------------------------------------------------------------------------
	-- Insert records to match

	INSERT INTO [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603] (snz_uid, reference_date, matching_date, age_ref_date, to_match)
	SELECT c.snz_uid
		,reference_date
		...
		,1 AS to_match
	FROM [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_client_202603] AS c
	INNER JOIN [IDI_Clean_202603].[data].[personal_detail] AS p
...
CREATE NONCLUSTERED INDEX i_uid ON [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603] (snz_uid)
GO
...
BEGIN 
	...
	UPDATE [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603]
	SET 
...
BEGIN 
	...
	FROM [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603] AS mt
	INNER JOIN [IDI_Clean_202603].[data].[personal_detail] AS p
...
DROP VIEW IF EXISTS [DL-MAA2026-04].[CHT__test_tmp_helper_202603]
GO
DROP INDEX i_uid ON [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603]
GO

-------------------------------------------------------------------------------
-- Index

CREATE NONCLUSTERED INDEX i_uid_std_date ON [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603] (snz_uid, std_start_date, std_end_date)
CREATE NONCLUSTERED INDEX i_uid_lag_date ON [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603] (snz_uid, lag_start_date, lag_end_date)
CREATE NONCLUSTERED INDEX i_references	 ON [SIA_Sandpit].[DL-MAA2026-04].[CHT__test_comparison_matching_master_table_202603] (age_ref_date, reference_date)
GO
