...
- Required conventions for this file:
	...
	- Table naming is [COHORT_client]
	- File name is COHORT_client.sql
...
DROP TABLE IF EXISTS [SIA_Sandpit].[DL-MAA2023-46].[_Test_client]
GO

CREATE TABLE [SIA_Sandpit].[DL-MAA2023-46].[_Test_client] (
...
INSERT INTO [SIA_Sandpit].[DL-MAA2023-46].[_Test_client]
SELECT snz_uid
...
CREATE NONCLUSTERED INDEX i_uid ON [SIA_Sandpit].[DL-MAA2023-46].[_Test_client] (snz_uid)
