...
DROP TABLE IF EXISTS [SIA_Sandpit].[DL-MAA2023-46].[_Test_target]
GO

CREATE TABLE [SIA_Sandpit].[DL-MAA2023-46].[_Test_target] (
...
INSERT INTO [SIA_Sandpit].[DL-MAA2023-46].[_Test_target]
SELECT snz_uid
...
CREATE NONCLUSTERED INDEX i_uid ON [SIA_Sandpit].[DL-MAA2023-46].[_Test_target] (snz_uid)
