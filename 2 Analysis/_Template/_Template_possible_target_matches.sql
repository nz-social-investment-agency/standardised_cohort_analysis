...
DROP TABLE IF EXISTS [SIA_Sandpit].[DL-MAA2023-46].[_Template_possible_target_matches]
GO

CREATE TABLE [SIA_Sandpit].[DL-MAA2023-46].[_Template_possible_target_matches] (
...
--INSERT INTO [SIA_Sandpit].[DL-MAA2023-46].[_Template_possible_target_matches]
--SELECT 
--FROM 
