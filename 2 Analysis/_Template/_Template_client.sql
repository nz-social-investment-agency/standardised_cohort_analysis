...
DROP TABLE IF EXISTS [SIA_Sandpit].[DL-MAA2023-46].[_Template_client]
GO

CREATE TABLE [SIA_Sandpit].[DL-MAA2023-46].[_Template_client] (
...
--INSERT INTO [SIA_Sandpit].[DL-MAA2023-46].[_Template_client]
--SELECT 
--FROM 
