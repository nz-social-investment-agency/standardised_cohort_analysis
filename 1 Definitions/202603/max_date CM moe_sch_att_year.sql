...
DROP VIEW IF EXISTS [DL-MAA2023-46].[max_date_CM_moe_sch_att_year_202506]
GO

CREATE VIEW [DL-MAA2023-46].[max_date_CM_moe_sch_att_year_202506] AS
WITH uid_list AS (
...
count_each_date AS (
	...
	SELECT CAST(DATEFROMPARTS([year],12,31) AS DATE) AS the_date
		, COUNT(*) AS num
	FROM [IDI_Community].[edu_sch_att_year].[sch_att_year_202506]
