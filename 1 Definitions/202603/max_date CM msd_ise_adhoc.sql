...
DROP TABLE IF EXISTS [$(PROJECT_DB)].[$(PROJECT_SCHEMA)].[max_date_CM_msd_ise_adhoc_$(REFRESH)]
GO
...
INTO [$(PROJECT_DB)].[$(PROJECT_SCHEMA)].[max_date_CM_msd_ise_adhoc_$(REFRESH)]
FROM uid_list
	,max_date
GO

CREATE NONCLUSTERED INDEX i_uid ON [$(PROJECT_DB)].[$(PROJECT_SCHEMA)].[max_date_CM_msd_ise_adhoc_$(REFRESH)] (snz_uid) INCLUDE (max_date)
GO
