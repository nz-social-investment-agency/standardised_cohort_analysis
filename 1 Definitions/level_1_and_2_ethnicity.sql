...
*******************************************************************************************/
/************************************
Census 2023 - currently not working, needs refinement
************************************/

--Impute rank description
--11	1 2023 Census form
--12    1 2023 Census individual variable sourced from dwelling/household set-up form
--21	2 2018 Census
--22	2 2013 Census
--31	37 Admin data
--51	99 Deterministic derivation
--41	99 Probabilistic imputation
--61	99 CANCEIS donor's response sourced from 2023 Census form
--62	99 CANCEIS donor's response sourced from 2023 Census dwelling/household set-up form
--63	99 CANCEIS donor's response sourced from admin data
--64	99 CANCEIS donor's response sourced from probabilistic imputation from members of UR household
--65	99 CANCEIS donor's response sourced from deterministic derivation
--66	99 CANCEIS donor's response sourced from 2018 Census
--67	99 CANCEIS donor's response sourced from 2013 Census
...
--		WHEN SUBSTRING([cen_ind_ethnic_grp_resp_level2],1,2) in ('94','95','96','97','98') THEN 98 
--		WHEN [cen_ind_ethgr_src_code] in ('11','12') THEN 1
--		WHEN [cen_ind_ethgr_src_code] in ('21','22') THEN 2 
--		WHEN [cen_ind_ethgr_src_code] in ('31') THEN 97
--		WHEN [cen_ind_ethgr_src_code] in ('41','51','61','62','63','64','65','66','67') THEN 99
...
SELECT snz_uid
	...
	,IIF(ethnic_code LIKE '%21%', 1, 0) AS lvl2_eth_21 -- Maori
