...
Example use:
EXEC [IDI_UserCode].[DL-MAA2026-04].[compress_table] @table = '[SIA_Sandpit].[DL-MAA2026-04].[non_neet_spells]'

To keep the original and compressed table:
EXEC [IDI_UserCode].[DL-MAA2026-04].[compress_table] @table = '[SIA_Sandpit].[DL-MAA2026-04].[non_neet_spells]', @swap_tables = 0

To just review the commands that will be executed:
EXEC [IDI_UserCode].[DL-MAA2026-04].[compress_table] @table = '[SIA_Sandpit].[DL-MAA2026-04].[non_neet_spells]', @debug = 1
*/

USE IDI_UserCode
GO

DROP PROCEDURE IF EXISTS [DL-MAA2026-04].[compress_table_SIA_Sandpit]
GO

CREATE PROCEDURE [DL-MAA2026-04].[compress_table_SIA_Sandpit]
