...
- [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_possible_client_matches]
...
DROP TABLE IF EXISTS [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table]
GO

CREATE TABLE [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table] (
...
FROM [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_possible_client_matches] AS m
...
INSERT INTO [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table] (snz_uid, reference_date, age_ref_date)
SELECT snz_uid
...
DELETE FROM [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table]
WHERE snz_uid IN (SELECT snz_uid FROM [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_client])
GO

-------------------------------------------------------------------------------
-- Insert records to match

INSERT INTO [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table] (snz_uid, reference_date, age_ref_date, to_match)
SELECT c.snz_uid
	...
	,1 AS to_match
FROM [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_client] AS c
INNER JOIN [IDI_Clean_202506].[data].[personal_detail] AS p
...
CREATE NONCLUSTERED INDEX i_uid ON [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table] (snz_uid)
GO
...
BEGIN 
	...
	UPDATE [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table]
	SET 
...
BEGIN 
	...
	FROM [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table] AS mt
	INNER JOIN [IDI_Clean_202506].[data].[personal_detail] AS p
...
DROP VIEW IF EXISTS [DL-MAA2023-46].[$COHORT_tmp_helper]
GO
DROP INDEX i_uid ON [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table]
GO

-------------------------------------------------------------------------------
-- Index

CREATE NONCLUSTERED INDEX i_uid_std_date ON [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table] (snz_uid, std_start_date, std_end_date)
CREATE NONCLUSTERED INDEX i_uid_lag_date ON [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table] (snz_uid, lag_start_date, lag_end_date)
CREATE NONCLUSTERED INDEX i_references	 ON [SIA_Sandpit].[DL-MAA2023-46].[$COHORT_comparison_matching_master_table] (age_ref_date, reference_date)
GO
