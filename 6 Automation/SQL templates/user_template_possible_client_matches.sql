...
CREATE TABLE [{PROJECT_DB}].[{PROJECT_SCHEMA}].[{PREFIX}{COHORT}_possible_client_matches_{REFRESH}] (
...
--INSERT INTO [{PROJECT_DB}].[{PROJECT_SCHEMA}].[{PREFIX}{COHORT}_possible_client_matches_{REFRESH}]
--SELECT 
--FROM 
...
CREATE NONCLUSTERED INDEX i_uid ON [{PROJECT_DB}].[{PROJECT_SCHEMA}].[{PREFIX}{COHORT}_possible_client_matches_{REFRESH}] (snz_uid)
